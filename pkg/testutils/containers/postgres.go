...
// Postgres wraps a PostgreSQL testcontainer instance
...
func (pc *Postgres) RunMigrations(t *testing.T, migrationsPath string) {
	t.Helper()
...
func (pc *Postgres) Close(ctx context.Context, t *testing.T) {
	t.Helper()
...
func (pc *Postgres) Truncate(t *testing.T, tables ...string) {
	t.Helper()
